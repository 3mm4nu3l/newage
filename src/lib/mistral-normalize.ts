...
type MistralMessageContent = NonNullable<NonNullable<NonNullable<MistralChatResponse["choices"]>[number]["message"]>["content"]>;
...
function extractTextContent(content: MistralMessageContent | undefined) {
